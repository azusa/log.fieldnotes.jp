...
![f:id:setoazusa:20180707214604p:plain](https://cdn-ak.f.st-hatena.com/images/fotolife/s/setoazusa/20180707/20180707214604.png "f:id:setoazusa:20180707214604p:plain")
...
![f:id:setoazusa:20180707215133p:plain](https://cdn-ak.f.st-hatena.com/images/fotolife/s/setoazusa/20180707/20180707215133.png "f:id:setoazusa:20180707215133p:plain")

# アプリケーションの動作の確認

以下は、App Serviceにデプロイしたアプリを2インスタンスにスケールアウトして、Spring Securityによるログイン処理が行われていることを確認した様子です。

![f:id:setoazusa:20180707215207p:plain](https://cdn-ak.f.st-hatena.com/images/fotolife/s/setoazusa/20180707/20180707215207.png "f:id:setoazusa:20180707215207p:plain")

![f:id:setoazusa:20180707215307p:plain](https://cdn-ak.f.st-hatena.com/images/fotolife/s/setoazusa/20180707/20180707215307.png "f:id:setoazusa:20180707215307p:plain")
