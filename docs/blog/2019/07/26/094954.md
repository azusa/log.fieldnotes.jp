...
![f:id:setoazusa:20190726094144p:plain](/images/blog/20190726094144.png "f:id:setoazusa:20190726094144p:plain")

下の画面イメージは、スクリプトの実行に失敗している場合のMackerel上におけるのアラートの様子です。

![f:id:setoazusa:20190726094153p:plain](/images/blog/20190726094153.png "f:id:setoazusa:20190726094153p:plain")
