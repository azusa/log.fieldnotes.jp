---
title: "devcontainerの環境を作成するためのプロンプト例"
date: 2026-05-15
---

# devcontainerの環境を作成するためのプロンプト例

## 感想

- 未完成。ログインシェルがbashでなくshになってしまうところとか → 追加した
- エージェントの動く環境をコンテナー化したいとなった途端にこういうビルド職人的ムーブが必要になるのが納得いかず…
...
- サービス名: 【例: myapp】
- ベースイメージ: 【例: node:24-trixie / python:3.12-slim など】
- 公開ポート: 【例: 3000】
